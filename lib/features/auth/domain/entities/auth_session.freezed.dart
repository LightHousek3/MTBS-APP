...
/// @nodoc
mixin _$RefreshSession {

 AuthUser get user; String get accessToken; String get refreshToken;
/// Create a copy of RefreshSession
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RefreshSessionCopyWith<RefreshSession> get copyWith => _$RefreshSessionCopyWithImpl<RefreshSession>(this as RefreshSession, _$identity);

  /// Serializes this RefreshSession to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RefreshSession&&(identical(other.user, user) || other.user == user)&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken));
}
...
@override
String toString() {
  return 'RefreshSession(user: $user, accessToken: $accessToken, refreshToken: $refreshToken)';
}
...
/// @nodoc
abstract mixin class $RefreshSessionCopyWith<$Res>  {
  factory $RefreshSessionCopyWith(RefreshSession value, $Res Function(RefreshSession) _then) = _$RefreshSessionCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$RefreshSessionCopyWithImpl<$Res>
    implements $RefreshSessionCopyWith<$Res> {
  _$RefreshSessionCopyWithImpl(this._self, this._then);

  final RefreshSession _self;
  final $Res Function(RefreshSession) _then;
...
/// Adds pattern-matching-related methods to [RefreshSession].
extension RefreshSessionPatterns on RefreshSession {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RefreshSession value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RefreshSession() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RefreshSession value)  $default,){
final _that = this;
switch (_that) {
case _RefreshSession():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RefreshSession value)?  $default,){
final _that = this;
switch (_that) {
case _RefreshSession() when $default != null:
return $default(_that);case _:
...
class _RefreshSession implements RefreshSession {
  const _RefreshSession({required this.user, required this.accessToken, required this.refreshToken});
  factory _RefreshSession.fromJson(Map<String, dynamic> json) => _$RefreshSessionFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$RefreshSessionCopyWith<_RefreshSession> get copyWith => __$RefreshSessionCopyWithImpl<_RefreshSession>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RefreshSessionToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RefreshSession&&(identical(other.user, user) || other.user == user)&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken));
}
...
/// @nodoc
abstract mixin class _$RefreshSessionCopyWith<$Res> implements $RefreshSessionCopyWith<$Res> {
  factory _$RefreshSessionCopyWith(_RefreshSession value, $Res Function(_RefreshSession) _then) = __$RefreshSessionCopyWithImpl;
@override @useResult
$Res call({
 AuthUser user, String accessToken, String refreshToken
});
...
/// @nodoc
class __$RefreshSessionCopyWithImpl<$Res>
    implements _$RefreshSessionCopyWith<$Res> {
  __$RefreshSessionCopyWithImpl(this._self, this._then);

  final _RefreshSession _self;
  final $Res Function(_RefreshSession) _then;

/// Create a copy of RefreshSession
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? user = null,Object? accessToken = null,Object? refreshToken = null,}) {
  return _then(_RefreshSession(
user: null == user ? _self.user : user // ignore: cast_nullable_to_non_nullable
as AuthUser,accessToken: null == accessToken ? _self.accessToken : accessToken // ignore: cast_nullable_to_non_nullable
as String,refreshToken: null == refreshToken ? _self.refreshToken : refreshToken // ignore: cast_nullable_to_non_nullable
as String,
